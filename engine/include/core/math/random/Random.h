...
public:
     ...
     */
    template <Arithmetic RetType, RandomGen Gen = std::default_random_engine, typename Distribution = Uniform<RetType>>
     ...
     * @return：生成的随机数, 其类型为 RetType (可计算类型)
     */
    template <Arithmetic RetType, RandomGen Gen = std::default_random_engine, typename Distribution = Gaussian<RetType>>
